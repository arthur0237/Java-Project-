...
class Global{
    ...
    static void setCid(){
        try{
        FileWriter f1 = new FileWriter("cid.txt");
        try{
...
public class DBpractice {
    DBpractice(){
    try{
    Global.con = DriverManager.getConnection("jdbc:mysql://localhost:3306/RMART","root","12345678");
    }
...
class awtP extends Frame{
    ...
    static void EmpInterface(){
        ...
        b1.setBackground(new Color(253,253,150));
        b2.setBackground(new Color(253,253,150));
        b3.setBackground(new Color(253,253,150));
...
class customer{
    ...
    scrollPane.setBounds(700,100,800,800);
